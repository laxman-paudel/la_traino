...
export default function DietTemplateCard({ template, onPreview, onEdit, onDuplicate, onAssign, onArchive, onRestore, onDelete, onToggleFavorite }) {
  const mealKeys = ["breakfast", "lunch", "dinner", "snack", "preWorkout", "postWorkout"];
